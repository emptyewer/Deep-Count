...
struct aoi {
  ...
  std::vector<double> csum_intensity;
  std::vector<double> csum_intensity_normalized;
  std::vector<double> csum_intensity_subtracted;
  std::vector<double> csum_y_intensity_histogram;
  std::vector<double> csum_x_intensity_histogram;
